...
def isWordGuessed(secretWord, lettersGuessed):
    ...
    newSortedSecretWord=[]
    for i in sortedSecretWord:
        if i not in newSortedSecretWord:
            newSortedSecretWord=newSortedSecretWord+[i,]
            
    if newSortedSecretWord==sortedlettersGuessed:
       a=True
    else:
       a=False
    return a
    ...
    * After each round, you should also display to the user the 
    ...
    while True :
       ...
       if letterGuessed in secretWord  :
           ...
           if lowerletterGuessed in newlettersGuessed:
          ...
          if numGuesses==0:
                  ...
                  break
       newlettersGuessed=newlettersGuessed+[lowerletterGuessed,]
    
# When you've completed your hangman function, uncomment these two lines
# and run this file to test! (hint: you might want to pick your own
# secretWord while you're testing)
hangman("pleasehelpme")
